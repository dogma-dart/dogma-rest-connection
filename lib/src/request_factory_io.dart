...
/// Initializes the [createRequest] function to construct instances of [RequestIO].
library dogma.rest_connection.src.request_factory_io;
...
/// Factory constructor for [RequestIO].
Request _createRequest(String url, RequestMethod method, ResponseType responseType)
    => new RequestIO(url, method: method, responseType: responseType);
